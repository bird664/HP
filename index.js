const contentLetterSrart_actived = "bấm vào hình món quà để nhận điều bất ngờ" //Lời mở đầu cho bức thư
const mainContentLetter = "Sinh nhật vui vẻ! Cuộc đời là một cuốn sách và mỗi năm là một chương mới. Chúc bạn sẽ viết nên những câu chuyện tuyệt vời và mở ra những chương mới thú vị." //Nội dung của bức thư
